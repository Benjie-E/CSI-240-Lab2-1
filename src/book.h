...
public:
	...
	void addReviews( const string& reviewFile );
	//calculate the average of the reviews
	float calculateAverageReview();
	//get the review (number of stars) with the highest count
	int getMostFrequentReview();
